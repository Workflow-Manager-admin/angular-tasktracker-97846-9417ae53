...
import {
  ...
  isDataSource
} from "./chunk-F3YBYL7B.js";
import {
  MatButton,
  MatButtonModule,
  MatIconButton
} from "./chunk-TOFLV2PP.js";
import {
  DateAdapter,
  MAT_DATE_FORMATS
} from "./chunk-MTRSUCF3.js";
import "./chunk-HFLJHOAB.js";
import "./chunk-46NGWB53.js";
import {
  _StructuralStylesLoader
} from "./chunk-MA4ZDJNP.js";
import {
  MAT_INPUT_VALUE_ACCESSOR
} from "./chunk-CTLEIHTZ.js";
import {
  ErrorStateMatcher,
  _ErrorStateTracker
...
var MatMonthView = class _MatMonthView {
  ...
  ngAfterContentInit() {
    this._rerenderSubscription = this._dateAdapter.localeChanges.pipe((0, import_operators4.startWith)(null)).subscribe(() => this._init());
  }
  ngOnChanges(changes) {
...
var MatDatepickerBase = class _MatDatepickerBase {
  ...
  close() {
    ...
    if (this._componentRef) {
      ...
      instance._animationDone.pipe((0, import_operators4.take)(1)).subscribe(() => {
  ...
  _getCloseStream(overlayRef) {
    ...
    return (0, import_rxjs4.merge)(overlayRef.backdropClick(), overlayRef.detachments(), overlayRef.keydownEvents().pipe((0, import_operators4.filter)((event) => {
